...
server.tool(toolName, toolDescription, { urls: inputSchema }, async (args) => {
    ...
    try {
        const responseLinks = await U301Request(`/shorten/bulk?workspaceId=${workspaceId}`, {
            method: "POST",
            headers: {
...
async function U301Request(url, options) {
    options = options || {};
...
function isFailedLink(link) {
    return link.error !== undefined;
}
function formatResults(links) {
